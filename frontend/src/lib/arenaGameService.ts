...
const ARENA_GAME_ID = "vorldtv_bffde7c5cd8434d920513f96ca0bfeb3";
...
export class ArenaGameService {
  ...
  disconnect(cancelSession: boolean = true): void {
    if (cancelSession && this.gameState?.sessionId && this.userToken) {
